...
import com.example.evanzeng.viewpagertest.ViewPager.NewTranformation;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView fix=new ImageView(MainActivity.this);
...
//        viewPager.setPageMargin(-50);
        ...
        viewPager.setPageTransformer(true,new NewTranformation());
